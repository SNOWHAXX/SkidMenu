    ...
    internal class Sabotage
    {
		...
		*/
        ...
        public static void FixSabotage(SystemTypes system)
        {
            switch (system)
            {
                ...
                case SystemTypes.Electrical:
                    ...
                    // SkidMenu.Log.LogMessage($"Actual: {switches.ActualSwitches}, expected: {switches.ExpectedSwitches}");
                ...
                case SystemTypes.MushroomMixupSabotage:
                    ...
                    SkidMenu.Log.LogInfo("Attempted to fix Mushroom Mixup, we are the host so it can be fixed");
        ...
        public static bool IsSabotageActive(SystemTypes system)
        {
            ...
            {
                SkidMenu.Log.LogError($"All sabotage types should extend from IActivatable, but yet {system} doesn't");
                return false;
            }
        ...
        public static void FixAllSabotages()
        {
            ...
            foreach (SystemTypes system in sabotages.Values)
            {
                if (!IsSabotageActive(system)) continue;
                FixSabotage(system);
            }
        }
